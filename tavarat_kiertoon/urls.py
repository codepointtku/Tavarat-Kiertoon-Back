...
from products.views import (  # ProductDetailView,; ProductListView,; StorageProductListView,
    ColorDetailView,
    ColorListView,
    PictureDetailView,
    PictureListView,
...
urlpatterns = [
    ...
    path("products/items/", ProductItemsListView.as_view()),
    path("products/item/<int:pk>", ProductItemDetailView.as_view()),
    ...
    path("user/edit/", UserUpdateInfoView.as_view()),
    path("user/address/edit/", UserAddressEditView.as_view()),
    path("user/address/edit/<int:pk>/delete/", UserAddressEditDeleteView.as_view()),
